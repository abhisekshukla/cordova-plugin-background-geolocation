...
import com.tenforwardconsulting.cordova.bgloc.data.sqlite.SQLiteDriveDetectionLocationDAO;
...
public abstract class DAOFactory {
	...
	public static LocationDAO createDriveDetectionLocationDAO(Context context) {
		return new SQLiteDriveDetectionLocationDAO(context);
	}
}
